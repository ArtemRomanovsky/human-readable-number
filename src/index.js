...
/*
   1. парсить полученное число на цифры разрядов (toString-> array[i+1]->reverse)
   2. получить строку для каждого разряда, добавить слова разрядов (сотни,десятки)
   3. объединить строки в одну
   4. вернуть результат
